...
int main(){
    ...
    ="/Users/wuhan/wuhan/CodingSpace/Code/opengl/shader/12/12.lighting_maps.vs.glsl";
    std::string colors_fragment_path
    ="/Users/wuhan/wuhan/CodingSpace/Code/opengl/shader/12/12.lighting_maps.fs.glsl";

    //光源着色器
    std::string light_cube_vertex_path
    ="/Users/wuhan/wuhan/CodingSpace/Code/opengl/shader/12/12.light_cube.vs.glsl";
    std::string light_cube_fragment_path
    ="/Users/wuhan/wuhan/CodingSpace/Code/opengl/shader/12/12.light_cube.fs.glsl";
