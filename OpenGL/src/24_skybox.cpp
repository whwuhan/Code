...
int main()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(cubeVertices), &cubeVertices, GL_STATIC_DRAW);//传递数据
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D, cubeTexture);//这里绑定的是cubeTexture 是6张图片
        ...
        skyboxShader.use();
        view = glm::mat4(glm::mat3(camera.GetViewMatrix())); // remove translation from the view matrix 天空盒其实是一直跟着镜头走的
