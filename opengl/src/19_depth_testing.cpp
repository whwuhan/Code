...
int main()
{
    ...
    //着色器
    std::string vertex_path="/Users/wuhan/wuhan/coding_space/Code/opengl/shader/19/19.depth_testing.vs.glsl";
    std::string fragment_path="/Users/wuhan/wuhan/coding_space/Code/opengl/shader/19/19.depth_testing.fs.glsl";
